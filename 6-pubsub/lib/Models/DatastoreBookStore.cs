...
namespace GoogleCloudSamples.Models
{
    public static class DatastoreBookStoreExtensionMethods
    {
        ...
        /// </summary>
        public static Property NewProperty(string value, bool indexed = true)
        {
            return null == value ? null : new Property()
            {
                StringValue = value,
                Indexed = indexed
            };
        ...
        public static Entity ToEntity(this Book book)
        {
            ...
            entity.Properties["Description"] = NewProperty(book.Description, indexed: false);
